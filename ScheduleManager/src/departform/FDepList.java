 ...
 * @author ART
 */
public class FDepList extends javax.swing.JFrame {

    private DataBaseConnect connector;
    
    /**
     * Creates new form FDepList
     */
    public FDepList() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FDepList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
