 ...
 * @author ART
 */
public class FHolidayInit extends javax.swing.JFrame {
    
    private String name;
    private String id;
    
    /**
     * Creates new form FHolidayInit
     */
    public FHolidayInit() {
        initComponents();
    }
    
    public FHolidayInit(String name, String id) {
        this.name = name;
        this.id = id;
        initComponents();
    ...
    private void initComponents() {
        ...
        btnEliminate.setText("Eliminar Férias");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FHolidayInit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FHolidayInit().setVisible(true);
            }
        });
    }
